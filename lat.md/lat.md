...
- [[office-2d]] — the Office tab's default flat 2D view: DOM-only locations and agent cards, the lazily loaded opt-in 3D scene, and the mission stand-in that replaces the walking sim.
